  ...
  return (
    <div className="glass p-10 md:p-16 rounded-[3.5rem] shadow-[0_0_100px_rgba(0,0,0,0.5)] border border-white/10 max-w-4xl mx-auto w-full animate-in fade-in zoom-in-95 duration-500 bg-slate-900/40 relative overflow-hidden">
      ...
      <div className="flex items-center gap-6 border-b border-white/10 pb-8 mb-10 relative z-10">
        ...
        <div>
          <h2 className="text-3xl md:text-4xl font-black text-white uppercase tracking-tight leading-none">Patient Profile</h2>
          <p className="text-sm text-cyan-400/60 uppercase tracking-[0.3em] font-black mt-2">Confirm Your Biometric Data for Clinical Accuracy</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-10 relative z-10">
        ...
        <div className="col-span-1 md:col-span-2 space-y-4">
          <div className="flex justify-between items-end">
            <label className="text-sm font-black text-cyan-400 uppercase tracking-widest">Age</label>
        ...
        <div className="space-y-4">
          <label className="text-sm font-black text-cyan-400 uppercase tracking-widest">Gender</label>
        ...
        {/* Corrective Lenses */}
        <div className="space-y-4">
          <label className="text-sm font-black text-cyan-400 uppercase tracking-widest">Corrective Lenses</label>
          <div className="flex gap-4">
        ...
        <div className="col-span-1 md:col-span-2 flex items-center gap-6 p-6 bg-cyan-950/20 rounded-3xl border border-cyan-500/20 hover:bg-cyan-900/30 transition-colors group cursor-pointer" onClick={() => setFamily(!family)}>
          ...
          <div>
            <label className="text-white font-black text-lg uppercase tracking-tight cursor-pointer">Family History of Eye Conditions</label>
            <p className="text-slate-500 text-xs font-bold uppercase tracking-widest mt-1">Include in clinical diagnosis and recommendations</p>
          </div>
        </div>
      </div>
      ...
      <button
        ...
        className="w-full mt-12 py-8 bg-white text-slate-950 rounded-[2rem] font-black uppercase text-2xl tracking-[0.3em] hover:bg-cyan-400 hover:shadow-[0_0_50px_rgba(34,211,238,0.4)] transition-all transform hover:scale-[1.01] active:scale-[0.99] relative overflow-hidden group shadow-2xl cursor-pointer"
      >
